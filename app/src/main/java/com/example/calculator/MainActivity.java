...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener listener= new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.btn0 || view.getId() == R.id.btn1 || view.getId() == R.id.btn2 || view.getId() == R.id.btn3 || view.getId() == R.id.btn4 || view.getId() == R.id.btn5 || view.getId() == R.id.btn6 || view.getId() == R.id.btn7 || view.getId() == R.id.btn8 || view.getId() == R.id.btn9 || view.getId() == R.id.btndot) {
                if (clear_flag) {
                    clear_flag = false;
                    editText.setText("");
                }
                editText.setText(input + ((Button) view).getText());
            } else if (view.getId() == R.id.btnadd || view.getId() == R.id.btnsub || view.getId() == R.id.btncheng || view.getId() == R.id.btnchu) {
                if (clear_flag) {
                    clear_flag = false;
                    input = "";
                    editText.setText("");
                ...
                if (!input.contains("-")) {
                    ...
                    String linshi = input;
                    String number = input.substring(1, linshi.length());
                ...
                if (clear_flag) {
                    ...
                    if (input.length() - 1 < 0) {
                        editText.setText(input.substring(0, 0));
                    } else {
                        editText.setText(input.substring(0, input.length() - 1));
                    }
                }
            } else if (view.getId() == R.id.btnequ) {
                getResult();
            }
        }
    };
